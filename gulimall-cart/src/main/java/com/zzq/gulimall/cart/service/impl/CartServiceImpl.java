package com.zzq.gulimall.cart.service.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.zzq.common.utils.R;
import com.zzq.gulimall.cart.feign.ProductFeignService;
import com.zzq.gulimall.cart.intercept.CartInterceptor;
...
import com.zzq.gulimall.cart.vo.SkuInfoVo;
...
public class CartServiceImpl implements CartService {
    ...
    /**
     * XXX 这样重定向，体验太差了。用ajax，然后dom局部刷新比较好
     */
    @Override
    ...
    public CartItemVo addToCart(Long skuId, Integer num) {
        ...
        if (StringUtils.isEmpty(productRedisValue)) {
            ...
            //等待所有的异步任务全部完成
            CompletableFuture.allOf(getSkuInfoFuture, getSkuAttrValuesFuture).join();
