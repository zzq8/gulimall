...
import com.zzq.gulimall.product.dao.BrandDao;
import com.zzq.gulimall.product.dao.CategoryBrandRelationDao;
...
public class CategoryBrandRelationServiceImpl extends ServiceImpl<CategoryBrandRelationDao, CategoryBrandRelationEntity> implements CategoryBrandRelationService {
    ...
    public List<BrandEntity> getBrandsByCatId(Long catId) {
        ...
        List<CategoryBrandRelationEntity> list = baseMapper.selectList(new QueryWrapper<CategoryBrandRelationEntity>()
                .eq("catelog_id", catId));

        //TODO 工作一年，规定不能循环访问数据库
